        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div>
                    ...
                    <?=\yii\helpers\Html::a('撰写新文章',['/article/create'],['class'=>'btn btn-primary'])?>
            ...
            <div class="panel-body">
                <ul class="list-unstyled">
                    <?php foreach($recentPublishedPost as $post): ?>
                        <li>
                            <span class="pull-right"><?=Yii::$app->formatter->asDate($post->addtime,'Y/MM/dd') ?></span>
                            <?=\yii\helpers\Html::a($post->title,Yii::$app->urlManager->createUrl(['article/view','id'=>$post->id]),['target'=>'_blank'])?>
                        </li>
                    <?php endforeach; ?>
